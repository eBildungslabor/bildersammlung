...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
    ...
    <xsl:template match="paragraphs">
        <div class="markdown">
            ...
            <xsl:apply-templates select="text()|ref|paragraphs|col|newcol|linebreak|br|ul|ol|li|b|qed|wiki"/>
        </div>
    </xsl:template>
    ...
    <xsl:template match="ul|ol|li|b|a">
